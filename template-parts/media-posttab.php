<!-- tab/pc版　メディア情報一覧用テンプレート -->
<div id="p-content--wrapper" class="p-content--tab--flex">
  <div class="p-media--flex--tab">
    <div class="p-thumbnail--container">
  ...
  <a href="#" id="c-button--info" class="c-button--info">
    <button>もっと見る</button>
  </a>
